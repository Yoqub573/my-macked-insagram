...
import { Bookmark, CircleUserRound, Heart, Loader, MessageCircle, MessageCircleMore, SendHorizontal, Volume2, VolumeX, X } from "lucide-react"
...
const Reels = () => {
    ...
    const { getPosts, posts, addPostFavorite } = useProfileByIdStore()
